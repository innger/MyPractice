...
import com.ryl.learn.guava.pojo.Customer;
...
public class BasicUtils {
    ...
    public void optional() {
        ...
        String[] arr = new String[] {"ren", "yu", "along"};
        Arrays.sort(arr);
...
//        assertTrue(Equivalences.identity().equivalent("hey", "hey"));
    ...
    public void needAnIntegerWhichIsNeverNull() {
        ...
        int kensId2 = firstNonNull(ken.getId(), null);
    ...
    public void somePreconditions() {
        ...
        assertEquals(Preconditions.checkNotNull(lisa.getId()), Integer.valueOf(2));
        
        Preconditions.checkState(!lisa.isSick()); // Will throw
        // IllegalStateException
        Preconditions.checkArgument(lisa.getAddress() != null, "We couldn't find the description for customer with id %s", lisa.getId());
    }
