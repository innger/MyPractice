...
public class GetTerminalDetailsClient implements ApiClientConstant {
    ...
    public String callWebService(String username, String password, String iccid) throws SOAPException, IOException, XWSSecurityException, Exception {
...
//            System.exit(-1);
//        }
        args = new String[]{"6247e65f-3f4f-4b68-beab-2f2547edf8cb","yaohongyii","autonavi2011","8986061501000308529"};
        GetTerminalDetailsClient terminalClient = new GetTerminalDetailsClient(url, args[0]);
        String res = terminalClient.callWebService(args[1], args[2], args[3]);
